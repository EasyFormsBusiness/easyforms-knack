        ...
        return regeneratorRuntime.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                sortField = _args5.length > 2 && _args5[2] !== undefined ? _args5[2] : false;
                sortOrder = _args5.length > 3 && _args5[3] !== undefined ? _args5[3] : false;
                retry = _args5.length > 4 && _args5[4] !== undefined ? _args5[4] : 1;
                page = 1;
                totalPages = 1;
                allRecords = [];
              ...
              case 34:
                return _context5.abrupt("return", this.search(objectNo, filters, sortField, sortOrder, retry += 1));
