...
var fs = require('fs-extra'); // Global (static) varibles (just primatives!)
...
function () {
  ...
  _createClass(Knack, [{
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 4:
                ...
                return _context3.abrupt("return", this.update(objectNo, record.id, object));

              case 11:
                return _context3.abrupt("return", this.create(objectNo, object));
    ...
    value: function () {
      ...
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee5(object, field, filepath) {
        var retry,
            data,
            file,
            id,
        ...
        return regeneratorRuntime.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                retry = _args5.length > 3 && _args5[3] !== undefined ? _args5[3] : 0;
                data = new FormData();
      ...
      return function upload(_x11, _x12, _x13) {
    ...
    value: function () {
      ...
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee6(objectNo, filters) {
        var sortField,
            sortOrder,
            retry,
            page,
        ...
        return regeneratorRuntime.wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                sortField = _args6.length > 2 && _args6[2] !== undefined ? _args6[2] : false;
                sortOrder = _args6.length > 3 && _args6[3] !== undefined ? _args6[3] : false;
                retry = _args6.length > 4 && _args6[4] !== undefined ? _args6[4] : 1;
                page = 1;
                totalPages = 1;
                allRecords = [];
              ...
              case 32:
                return _context6.abrupt("return", this.search(objectNo, filters, sortField, sortOrder, retry += 1));

              case 35:
                console.error('Error searching in knack', _context6.t0);
    ...
    value: function () {
      ...
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee7(objectNo) {
        var retry,
            allRecords,
            page,
            totalPages,
        ...
        return regeneratorRuntime.wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                retry = _args7.length > 1 && _args7[1] !== undefined ? _args7[1] : 1;
                allRecords = [];
                page = 1;
                totalPages = 1;
                _context7.prev = 4;
    ...
    value: function () {
      ...
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee8(objectNo, id) {
        var retry,
            _args8 = arguments;
        return regeneratorRuntime.wrap(function _callee8$(_context8) {
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                retry = _args8.length > 2 && _args8[2] !== undefined ? _args8[2] : 1;
                _context8.prev = 1;
                _context8.next = 4;
      ...
      return function getOne(_x17, _x18) {
...
function sleep(_ref5) {
  var _ref5$min = _ref5.min,
      min = _ref5$min === void 0 ? 1000 : _ref5$min,
      _ref5$max = _ref5.max,
      max = _ref5$max === void 0 ? 10000 : _ref5$max;
