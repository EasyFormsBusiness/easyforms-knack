...
var qs = require("qs"); // Global (static) varibles (just primatives!)
...
function () {
  ...
  _createClass(Knack, [{
    ...
    value: function () {
      ...
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee3(objectNo, object) {
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                filters = Object.keys(object).reduce(function (obj, field) {
                  obj.rules.push({
                    field: field,
                    operator: "is",
                    value: object[field]
    ...
    value: function () {
      ...
      return function search(_x10, _x11) {
