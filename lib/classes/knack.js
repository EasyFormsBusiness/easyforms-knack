...
function () {
  ...
  _createClass(Knack, [{
          ...
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                ...
                parse = _args7.length > 5 && _args7[5] !== undefined ? _args7[5] : true;
                page = 1;
                totalPages = 1;
                allRecords = [];
    ...
    value: function () {
      ...
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee11(objectNo) {
        var response;
      ...
      return function getObject(_x21) {
