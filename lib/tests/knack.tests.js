          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.t0 = console;
                _context.next = 3;
                return knack.getOne('object_1', testRecord);
        ...
        return regeneratorRuntime.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _context4.next = 2;
                return knack.parse('object_1', newObj);

              case 2:
                parsedRecord = _context4.sent;
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 6:
                ...
                assert.equal(_context5.t0.message, 'You must pass a body');
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              ...
              case 6:
                ...
                assert.equal(_context6.t0.message, 'You must pass an object number');
          ...
          while (1) {
            switch (_context10.prev = _context10.next) {
              case 0:
                ...
                _context10.next = 3;
                return knack.upload('object_14', 'field_156', '/home/tkettle/code/knack/.eslintrc.json');
        ...
        return regeneratorRuntime.wrap(function _callee11$(_context11) {
          while (1) {
            switch (_context11.prev = _context11.next) {
              ...
              case 3:
                _context11.t1 = _context11.sent.length;
