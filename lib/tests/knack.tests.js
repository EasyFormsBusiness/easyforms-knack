          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 6:
                ...
                assert.equal(_context3.t0.message, "You must pass a body");
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 6:
                ...
                assert.equal(_context4.t0.message, "You must pass an object number");
        ...
        return regeneratorRuntime.wrap(function _callee8$(_context8) {
          while (1) {
            switch (_context8.prev = _context8.next) {
              ...
              case 3:
                _context8.t1 = _context8.sent.length;
